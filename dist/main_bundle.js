...
var arrayAggregator = __webpack_require__(98),
    baseAggregator = __webpack_require__(108),
...
var baseForOwnRight = __webpack_require__(112),
    createBaseEach = __webpack_require__(59);
...
var arrayMap = __webpack_require__(16),
    ...
    compareMultiple = __webpack_require__(139),
    identity = __webpack_require__(11);
...
var arrayEachRight = __webpack_require__(100),
    baseEachRight = __webpack_require__(46),
    castFunction = __webpack_require__(57),
    isArray = __webpack_require__(0);
...
var _dataSort = __webpack_require__(77);

// Module for loading the JSON file
var d3_request = __webpack_require__(89);

// Async load the data
d3_request.json("../assets/data/register.json", function (err, data) {
  ...
  input.addEventListener("input", function (e) {
    ...
    var filtered = (0, _dataSort.searchPlanograms)(data, e.currentTarget.value);
    dataCont.innerHTML = (0, _dataSort.displayData)(filtered);
  });

  var linkCont = document.querySelector(".dataLinks");
    ...
    var _loop = function _loop() {
      ...
      if (link.children[0].dataset.link) {
        link.children[0].addEventListener("click", function () {
          ...
          try {
            for (var _iterator2 = linkCont.children[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var _link = _step2.value;

              if (_link.children[0].dataset.link) {
                _link.children[0].classList.remove("highlighted");
                _link.children[0].children[0].innerHTML = '<i class="fa fa-angle-up" aria-hidden="true"></i>';
              }
            }
          ...
          var sorted = (0, _dataSort.sortData)(data, link.children[0].dataset.link);
          ...
          dataCont.innerHTML = (0, _dataSort.displayData)(sorted);
        });
      }
    };

    for (var _iterator = linkCont.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      _loop();
    }
  } catch (err) {
...
exports.searchPlanograms = searchPlanograms;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_keys__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_entries__ = __webpack_require__(79);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dispatch__ = __webpack_require__(85);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dsv__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_csv__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_tsv__ = __webpack_require__(88);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dsv__ = __webpack_require__(27);
...
(function (global, factory) {
   true ? factory(exports, __webpack_require__(78), __webpack_require__(84), __webpack_require__(86)) :
...
module.exports = {
  'countBy': __webpack_require__(192),
  'each': __webpack_require__(193),
  'eachRight': __webpack_require__(194),
  'every': __webpack_require__(195),
  'filter': __webpack_require__(196),
  'find': __webpack_require__(197),
  'findLast': __webpack_require__(199),
  'flatMap': __webpack_require__(201),
  'flatMapDeep': __webpack_require__(202),
  'flatMapDepth': __webpack_require__(203),
  'forEach': __webpack_require__(69),
  'forEachRight': __webpack_require__(70),
  'groupBy': __webpack_require__(205),
  'includes': __webpack_require__(207),
  'invokeMap': __webpack_require__(208),
  'keyBy': __webpack_require__(209),
  'map': __webpack_require__(24),
  'orderBy': __webpack_require__(213),
  'partition': __webpack_require__(214),
  'reduce': __webpack_require__(216),
  'reduceRight': __webpack_require__(217),
  'reject': __webpack_require__(218),
  'sample': __webpack_require__(219),
  'sampleSize': __webpack_require__(220),
  'shuffle': __webpack_require__(221),
  'size': __webpack_require__(222),
  'some': __webpack_require__(223),
...
var baseForRight = __webpack_require__(113),
    keys = __webpack_require__(8);
...
var arraySample = __webpack_require__(43),
...
var arrayEvery = __webpack_require__(101),
    baseEvery = __webpack_require__(109),
    baseIteratee = __webpack_require__(1),
    isArray = __webpack_require__(0),
...
var apply = __webpack_require__(30),
    baseEach = __webpack_require__(3),
    baseInvoke = __webpack_require__(117),
...
var baseOrderBy = __webpack_require__(51),
    isArray = __webpack_require__(0);
...
var arrayReduce = __webpack_require__(103),
    baseEach = __webpack_require__(3),
    baseIteratee = __webpack_require__(1),
    baseReduce = __webpack_require__(54),
    isArray = __webpack_require__(0);
...
var arrayReduceRight = __webpack_require__(104),
    baseEachRight = __webpack_require__(46),
    baseIteratee = __webpack_require__(1),
    baseReduce = __webpack_require__(54),
    isArray = __webpack_require__(0);
...
var arraySample = __webpack_require__(43),
    baseSample = __webpack_require__(127),
    isArray = __webpack_require__(0);
...
var arraySampleSize = __webpack_require__(105),
    baseSampleSize = __webpack_require__(128),
    isArray = __webpack_require__(0),
    isIterateeCall = __webpack_require__(21),
    toInteger = __webpack_require__(14);
...
var arrayShuffle = __webpack_require__(106),
    baseShuffle = __webpack_require__(130),
    isArray = __webpack_require__(0);
...
var arraySome = __webpack_require__(44),
    baseIteratee = __webpack_require__(1),
    baseSome = __webpack_require__(132),
    isArray = __webpack_require__(0),
    isIterateeCall = __webpack_require__(21);
